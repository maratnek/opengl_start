...
GLuint ShaderLoader::createProgramm(const char* vertShaderFilename, const char* fragShaderFilename) {
    ...
    GLuint vertex_shader = createShader(GL_VERTEX_SHADER, vertShaderCode, "vertex shader");
    GLuint fragment_shader = createShader(GL_FRAGMENT_SHADER, fragShaderCode, "fragment shader");
